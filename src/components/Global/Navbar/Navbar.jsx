			...
			<div className='container'>
				...
				<div className='collapse navbar-collapse' id='navbarSupportedContent'>
						...
						<ul className='navbar-nav me-auto mb-2 mb-lg-0'>
							...
							<li className='nav-item'>
								<NavLink className='nav-link position-relative' to={'/cart'}>
									...
									<span className='cartNumber'>{cartCount ? cartCount : 0}</span>
								</NavLink>
							</li>
							<li className='nav-item'>
								<NavLink className='nav-link position-relative' to={'/wishlist'}>
									WishList <i className='fa-solid fa-rectangle-list'></i>
									<span className='cartNumber'>{wishListCount ? wishListCount : 0}</span>
								</NavLink>
							</li>
							<li className='nav-item'>
					...
					<ul className='navbar-nav ms-auto mb-2 mb-lg-0'>
						...
						{userToken !== null ? (
							<li className='nav-item'>
								<span className='nav-link cursor-pointer' aria-current='page' onClick={LogOut}>
									LogOut
								</span>
							</li>
						) : (
